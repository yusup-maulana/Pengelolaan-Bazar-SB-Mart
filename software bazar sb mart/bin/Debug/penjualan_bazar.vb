...
Public Class penjualan_bazar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "software_bazar_sb_mart.penjualan_bazar.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TanggalMulai() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TanggalSelesai() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedpenjualan_bazar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As penjualan_bazar = New penjualan_bazar()
        rpt.Site = Me.Site
        Return rpt
    End Function
